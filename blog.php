	...
	<div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li class="home class">
                    <a href="#" class="link" style="font-family: Museo;">Home <i class="fa fa-home socia link" aria-hidden="true"></i></a>
                </li>
                <li class="class" >
                    <a href="#" class="link" style="font-family: Museo;">About</a>
                </li>
                <li class="class" >
                    <a href="#" class="link" style="font-family: Museo;">Services</a>
                </li>
                <li class="class" >
                    <a href="#" class="link" style="font-family: Museo;">Portfolio</a>
                </li>
                <li class="class" >
                    <a href="#" class="link" style="font-family: Museo;">Contact</a>
                </li>
                <li class="dropdown class="class" ">
                    <a href="#" class="dropdown-toggle link" data-toggle="dropdown" style="font-family: Museo;">Follow us<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li class="class" ><a href="#" class="link" style="font-family: Museo;">facebook</a></li>
                        <li class="class" ><a href="#" class="link" style="font-family: Museo; color: white;">twitter</a></li>
                        <li class="class" ><a href="#" class="link" style="font-family: Museo;color: white;">Instagram</a></li>
                        <li class="class" ><a href="#" class="link" style="font-family: Museo;color: white;">Linkedin</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
    ...
    <div class="header-bottom">
        <div class="container">
            <div class="logo wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
                <h1><a href="index.html">EFFLUX BLOG</a></h1>
                <p><label class="of"></label>LET'S EFFLUX A PERFECT INFO<label class="on"></label></p>
            </div>
        </div>
    </div>
